...
namespace NotePad
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeFontComboBox()
        {
            ...
            {
                comboBoxFon.Items.Add(font.Name);
            }
            // 設置預設選中的項目為第一個字體
        ...
        private void comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                // 從下拉選單中獲取選擇的字型、大小和樣式
                string selectedFont = comboBoxFon.SelectedItem?.ToString();
                ...
                if (selectedFont != null && selectedSizeStr != null && selectedStyleStr != null)
                {
                    ...
                    rtbText.SelectionFont = new Font(selectedFont,selectedSize,selectedStyle);
                    #region 以下是老師寫的
                    // 獲取當前選擇的文字的字型
